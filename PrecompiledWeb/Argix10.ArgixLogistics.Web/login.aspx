<%@ page title="Argix Login" language="C#" autoeventwireup="true" inherits="_Login, App_Web_skqearqo" %>
...
<form runat="server">
    <div class="container">
        <div class="navigation">
            <div style="float:left"><a href="index.html"><img src="images/argix_logo.gif" width="290" height="131" alt="Argix" border="0" /></a></div>
        ...
        <div class="login"><a href="login.aspx" style=""><img src="images/login.png" alt="Login" style="border:0 none" /></a></div>
        <div class="header-blank"></div>
        <div id="title">Login</div>
        <div style="padding-left:100px">
            <div class="loginpanel">
                <p class="sectiontitle">Carton Tracking Client</p>
                <p>
                    <a href="http://www.argixlogistics.com/tracking/login.aspx" style=""><img src="images/tracking.png" alt="Tracking Login" style="float:right; width:150px; border:0 none" /></a>
                    If you are a Carton Tracking client, click here to login to our Carton Tracking site.
                </p>
            </div>
            <div class="loginpanel">
                <p class="sectiontitle">Pallet Shipment Client</p>
                <p>
                <a href="http://www.argixlogistics.com/psp/account/login.aspx" style=""><img src="images/palletshipment.png" alt="Pallet Shipment Login" style="float:right; width:150px; border:0 none" /></a>
                    If you are a Pallet Shipment client, click here to login to our Pallet Shipment site.
                </p>
            </div>
        </div>
	    <div style="clear:both;"></div>
        ...
        <div class="footer"><p>Argix Logistics | 732.656.2550 | Copyright 2012 - 2014 | <a href="privacy.html" target="_self" title="Privacy Notice" style="width:150px; color:black; text-decoration:underline;">Privacy Notice</a></p></div>
    </div>
</form>
</body>
</html>