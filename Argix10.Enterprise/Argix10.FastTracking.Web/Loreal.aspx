<%@ Page Language="C#" MasterPageFile="~/Default.master" AutoEventWireup="true" CodeFile="Loreal.aspx.cs" Inherits="Propak" Title="Argix Logistics Fast Tracking" %>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
	            ...
	            <tr>
	                <td  align="right" style="height: 19px">
                        <asp:LinkButton ID="btnTrack2" runat="server" OnClick="OnTrack" >Track</asp:LinkButton>
                        &nbsp;<asp:ImageButton ID="btnTrack" runat="server" ImageUrl="~/App_Themes/ArgixDirect/Images/btn_arrow_red_right.gif" ImageAlign="AbsBottom" OnClick="OnTrackImg" /> &nbsp;&nbsp;
		            </td>
	            </tr>
            </table>
        </td>
