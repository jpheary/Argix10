...
<div>
    &nbsp;<asp:Label ID="Label1" runat="server" Height="25px" style="font-size:20px" Text="Tracking Results Summary" ></asp:Label>
    <br /><br />
    <asp:GridView ID="grdTrack" runat="server" Width="775px" Height="100px" AutoGenerateColumns="False" DataKeyNames="LabelNumber" OnRowDataBound="OnItemDataBound">
        <Columns>
