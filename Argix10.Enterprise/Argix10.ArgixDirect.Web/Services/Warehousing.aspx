<%@ Page Title="Warehousing" Language="C#" MasterPageFile="~/Services/Services.master" AutoEventWireup="true" CodeFile="Warehousing.aspx.cs" Inherits="Warehousing" %>

<asp:Content ID="cContent" runat="server" ContentPlaceHolderID="PageContent">
	<img runat="server" class="imgFloatRight" src="~/styles/images/warehousing.jpg"  alt="Warehousing" width="240" />
