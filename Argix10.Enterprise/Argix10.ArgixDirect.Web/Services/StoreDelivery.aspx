<%@ Page Title="Store Delivery" Language="C#" MasterPageFile="~/Services/Services.master" AutoEventWireup="true" CodeFile="StoreDelivery.aspx.cs" Inherits="StoreDelivery" %>

<asp:Content ID="cContent" runat="server" ContentPlaceHolderID="PageContent">
	<img runat="server" class="imgFloatRight" src="~/styles/images/deliveries.jpg"  alt="Store Deliveries" width="240" />
	<div  class="textContainer"> 
        ...
        <p>We have 42 delivery terminals nationwide that support your time sensitive shipments. As always, you can fully track your shipments with our proprietary SmartScan technology. Our goal is to support our clients with less internal handling and lower overall costs.</p>
	</div>
</asp:Content>
