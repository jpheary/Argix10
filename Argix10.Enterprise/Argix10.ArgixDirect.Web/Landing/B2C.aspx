<%@ page Title="Argix Direct - B2C" language="C#" autoeventwireup="true" CodeFile="B2C.aspx.cs" Inherits="B2C" %>
...
<div id="container">
    ...
    <div id="sectionGap_thinGrey"></div>
    <form id="infoForm" runat="server" name="infoForm" method="post" action="~/Landing/B2C.aspx" > 
        <div id="contentMid">   
