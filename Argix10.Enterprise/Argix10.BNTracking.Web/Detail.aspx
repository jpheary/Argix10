...
<head id="Head1" runat="server">
    <title>Argix Logistics ~ Tracking Detail</title>
...
<div class="detailGridContainer">
       <asp:Label ID="Label1" runat="server" SkinID="lblTextDetail" Text="Tracking History" Width="758px" Height="28px" Backcolor="#EEEEEE"></asp:Label>
        ...
        <asp:GridView ID="grdDetail" runat="server" Width="780px" AutoGenerateColumns="False" Backcolor="white" CellSpacing="1" BorderStyle="None" SkinID="GridSkin" >
            <Columns>
...
<p></p>
 ...
 <div id="labelContainer" >
       <p> Argix Logistics utilizes the US Postal Service to make the final delivery of your order(s). The US Postal Service passes the tracking information on to Argix Logistics as the package moves through the delivery process. 
