...
<head id="Head1" runat="server">
    <title>Argix Logistics ~ Tracking Summary</title>
    ...
    <div class="content">
        <form id="form1" runat="server">
            <div class="detailGridContainer">
                <asp:Label ID="Label1" runat="server" Text="Tracking Results Summary" Width="775px" Height="28px" SkinID="lblTextDetail" ></asp:Label>
                &nbsp;
                <br />
        ...
        <div id="labelContainer">
            <asp:Label ID="lblSumFootnote" runat="server" SkinID="lblText" Text="Tracking data provided by Argix Logistics." Width="384px"></asp:Label>
        </div>
    </div>
</div>
</body>
