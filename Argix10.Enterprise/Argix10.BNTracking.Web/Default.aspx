						        ...
						        <table style="width:480px; height:100%" border="0" cellpadding="0" cellspacing="1">
							        <tr>
                                        ...
                                        <td style="width:48px">
                                            ...
                                            <asp:CustomValidator ID="cvTrack" runat="server" ClientValidationFunction="ValidateNumbers" ControlToValidate="txtNumbers" ErrorMessage="Each tracking number must be 22 or 30 numeric characters." ValidateEmptyText="True">*</asp:CustomValidator>
                                        </td>
							        </tr>
							        <tr>
