...
<title>Argix :: Transportation</title>
<!-- InstanceEndEditable -->
...
<div class="container">
  ...
  <div class="header"><!-- InstanceBeginEditable name="Header" --><img src="images/transportation.jpg" width="960" height="266" alt="Argix Transportation" />
<!-- InstanceEndEditable --></div>
  <div class="content"><!-- InstanceBeginEditable name="Main Content" -->    <p class="body-nav">Home > Transportation &gt;<span class="sub-nav-highlight"> Nationwide B2C Delivery</span></p> 
    <span class="big_caps">N</span><span class="titles">ationwide B2C Delivery.</span>
    <p class="body-copy">Tired of the same old small package delivery choices? There is another way!<br />
    </p>
    <p class="body-copy">Argix Logistics offers customized direct-to-consumer delivery solutions that save time, limit handling and control costs. Whether it's catalog, ecommerce, seasonal or small parcel shipping and delivery, you'll get the reliability, security and system support that's synonymous with the Argix name.</p>
    <p class="body-copy">
      We combine our work-share partnership and certifications with the U.S. Postal<br />
      Service with our other specialized delivery services to leverage better efficiency,<br />
      flexibility and savings for your direct-to-consumer delivery needs. Your customers will enjoy full parcel tracking, a convenience expected by today's sophisticated consumer.</p>
  <!-- InstanceEndEditable -->
</div>
      <!-- InstanceBeginEditable name="Side Bar" -->
      <div class="side_bar_b2c">
<p class="sub-nav"><span class="sub-nav-bigger">Transportation</span><br />
Nationwide B2B Delivery<br />
<span class="sub-nav-highlight">Nationwide B2C Delivery</span><br />
DC Bypass<br />
LTL Delivery<br />
Regional Delivery</p></div><!-- InstanceEndEditable -->
