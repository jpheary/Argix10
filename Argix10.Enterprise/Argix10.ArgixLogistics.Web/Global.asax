...
<script runat="server">
    ...
    void Application_Error(object sender, EventArgs e) {
        ...
        if(exc == null) {
            ...
            //    new Argix.Freight.FreightGateway().WriteLogEntry(Argix.Freight.LogLevel.Error, username, exc);
            //    new Argix.Enterprise.SMTPGateway().SendITNotification(username, exc);
            //}
            //catch { }
        }
    }
    void Session_Start(object sender, EventArgs e) {
        ...
        //if (useragent.Contains("mobile")) HttpContext.Current.Response.Redirect("~/Mobile/Index.aspx");
    }
