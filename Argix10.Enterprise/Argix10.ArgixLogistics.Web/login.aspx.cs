...
public partial class _Login : System.Web.UI.Page {
    ...
    //protected void OnLoginImg(object sender,ImageClickEventArgs e) { OnLogin(null,null); }
    ...
    //        if(users.Count == 0) { rfvUserID.IsValid = false; rfvUserID.ErrorMessage = USER_LOGIN_NOACCOUNT; return; }
    //        if(users[username].IsLockedOut) { rfvUserID.IsValid = false; rfvUserID.ErrorMessage = USER_ACCOUNT_LOCKEDOUT; return; }
    //        if(!users[username].IsApproved) { rfvUserID.IsValid = false; rfvUserID.ErrorMessage = USER_ACCOUNT_INACTIVE; return; }
    ...
    //                    Response.Redirect((url != null? url : "/tracking/members/default.aspx"), true);
    //                //}
    //            } 
