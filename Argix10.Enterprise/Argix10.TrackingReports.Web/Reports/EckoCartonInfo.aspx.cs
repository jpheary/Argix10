...
public partial class EckoCartonInfo :System.Web.UI.Page {
    //Members
    private string mTitle = "Ecko Carton Info";
    private string mSource = "/Tracking/Ecko Carton Info";
        ...
        try {
            ...
            switch(e.CommandName) {
                ...
                case "Excel":
                    ...
                    Response.Clear();
                    Response.Charset = "";
                    Response.AddHeader("Content-Disposition","inline; filename=EckoCartonInfo.xls");
