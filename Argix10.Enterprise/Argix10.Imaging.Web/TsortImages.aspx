...
<asp:Content ID="cBody" runat="server" ContentPlaceHolderID="cpBody">
    ...
    <ContentTemplate>
        <table style="width:100%; text-align:left">
            ...
            <tr><td colspan="2" class="subtitle">Tsort Images</td></tr>
            <tr>
                <td style="text-align:right">Document Class&nbsp;</td>
                <td><asp:DropDownList ID="cboDocClass" runat="server" DataSourceID="odsDocs" DataTextField="ClassName" DataValueField="ClassName" Width="144px" AutoPostBack="True" OnSelectedIndexChanged="OnDocClassChanged" />
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="cboOperand2" runat="server"  Width="75px" ><asp:ListItem Text="AND" Value="AND" /><asp:ListItem Text="OR" Value="OR" /></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
                    ...
                    <asp:TextBox ID="txtSearch3" runat="server" MaxLength="30" />
                    <asp:DropDownList ID="cboOperand3" runat="server" Width="75px" ><asp:ListItem Text="AND" Value="AND" /><asp:ListItem Text="OR" Value="OR" /></asp:DropDownList></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td>
                    ...
                    <asp:TextBox ID="txtSearch4" runat="server" MaxLength="30" />
                </td>
            </tr>
