...
public partial class BNConsumerDirectCartonDetail:System.Web.UI.Page {
    //Members
    private string mTitle = "B&N Consumer Direct Carton Detail";
    private string mSource = "/Consumer Direct/BN Consumer Direct Carton Detail";
    private string mDSName = "ConsumerDirectCartonDetailDS";
    private string mUSPName = "uspRptConsumerDirectCartonDetail",mTBLName = "NewTable";
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        try {
            ...
            DataSet ds = enterprise.FillDataset(this.mUSPName,mTBLName,new object[] { _start,_end,_delivDays,_locType,_vendor });
