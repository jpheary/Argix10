...
<asp:Table runat="server" ID="tblControl" Width="100%" BorderStyle="None" BorderWidth="2px" CellPadding="2" CellSpacing="2">
    <asp:TableRow runat="server" ID="rowFrom">
        <asp:TableCell runat="server" ID="colFromLabel" Width="75px" HorizontalAlign="Right">From</asp:TableCell>
        <asp:TableCell runat="server">
            <asp:UpdatePanel ID="upnlFrom" runat="server" UpdateMode="Conditional" >
            <ContentTemplate>
                <asp:TextBox runat="server" ID="txtFrom" ReadOnly="True" Width="100%" Text="" />
                <asp:Panel runat="server" ID="pnlDateFrom" ToolTip="From" style="display:none;position:absolute; height:175px; z-index:2; background-color:Transparent; border-style:none" >
    ...
    <asp:TableRow runat="server" ID="rowTo">
        <asp:TableCell runat="server" ID="colToLabel" Width="75px" HorizontalAlign="Right">To</asp:TableCell>
        <asp:TableCell runat="server">
            <asp:UpdatePanel ID="upnlTo" runat="server" UpdateMode="Conditional" >
            <ContentTemplate>
                <asp:TextBox runat="server" ID="txtTo" ReadOnly="True" Width="100%" Text="" />
                <asp:Panel runat="server" ID="pnlDateTo" ToolTip="From" style="display:none; position:absolute; height:175px; z-index:2; background-color:Transparent; border-style:none" >
