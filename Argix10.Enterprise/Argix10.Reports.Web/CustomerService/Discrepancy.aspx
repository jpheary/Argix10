...
<%@ Register Src="~/ClientMultiShipperGrids.ascx" TagName="ClientMultiShipperGrids" TagPrefix="uc3" %>
...
<asp:Panel ID="pnlSetup" runat="server" Width="100%" Height="100%" GroupingText="Setup">
    <table width="100%" border="0px" cellpadding="0" cellspacing="3px">
        ...
        <tr style="font-size:1px; height:6px"><td colspan="3">&nbsp;</td></tr>
        <tr><td colspan="3">&nbsp;<uc3:ClientMultiShipperGrids ID="dgdClientShipper" runat="server" Height="300px" ClientsEnabled="true" ShippersEnabled="false" FreightType="Regular" FreightTypeEnabled="false" OnAfterClientSelected="OnClientSelected" OnAfterShipperSelected="OnShipperSelected" OnControlError="OnControlError" /></td></tr>
   </table>
</asp:Panel>
</asp:Content>
