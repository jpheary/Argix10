...
<table style="width:100%">
    ...
    <tr style="font-size:1px; height:6px"><td colspan="3">&nbsp;</td></tr>
    <tr><td colspan="3" style="text-align:right"><asp:CheckBox ID="chkAllVendors" runat="server" Width="288px" Text="Pickups for all vendors" TextAlign="Right" Checked="true" AutoPostBack="True" OnCheckedChanged="OnAllVendorsChecked" /></td></tr>
    <tr style="font-size:1px; height:6px"><td colspan="3">&nbsp;</td></tr>
