...
<table style="width:100%">
    ...
    <tr><td colspan="3" style="text-align:right"><asp:CheckBox ID="chkAllVendors" runat="server" width="288px" Text="Pickups for all vendors" TextAlign="Left" Checked="true" AutoPostBack="True" OnCheckedChanged="OnAllVendorsChecked" /></td></tr>
    <tr style="font-size:1px; height:6px"><td colspan="3">&nbsp;</td></tr>
