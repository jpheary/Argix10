...
public partial class OnTimeByDayAndWindowException :System.Web.UI.Page {
    //Members
    private string mTitle = "On Time By Day And Window Exception";
    private string mSource = "/Customer Service/On Time By Day And Window Exception";
    private string mDSName = "OnTimeExceptionDS";
    private string mUSPName = "uspRptOnTimeReportByDayAndWindowException",mTBLName = "NewTable";
    ...
    protected void OnButtonCommand(object sender,CommandEventArgs e) {
        ...
        try {
            ...
            DataSet ds = enterprise.FillDataset(this.mUSPName,mTBLName,new object[] { _client,_div,_from.ToString("yyyy-MM-dd"),_to.ToString("yyyy-MM-dd"),(_agent == "All" ? null : _agent) });
