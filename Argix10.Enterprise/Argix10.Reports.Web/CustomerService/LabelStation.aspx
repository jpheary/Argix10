            ...
            <td colspan="2">
                ...
                <ContentTemplate>
                   <asp:DropDownList ID="cboSearchBy" runat="server" width="144px" AutoPostBack="True" OnSelectedIndexChanged="OnSearchByChanged">
                    ...
                    &nbsp;<asp:ImageButton ID="btnFind" runat="server" ImageUrl="~/App_Themes/Reports/Images/search.gif" BorderStyle="Outset" BorderWidth="2px" Height="16px" ImageAlign="Middle" ToolTip="Search for Argix cartons" OnClick="OnFindCartons" />
                </ContentTemplate>
                </asp:UpdatePanel>
            </td>
            <td>&nbsp;</td>
