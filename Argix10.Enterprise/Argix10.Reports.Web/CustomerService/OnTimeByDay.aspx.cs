...
public partial class OnTimeByDay :System.Web.UI.Page {
    //Members
    private string mTitle = "On Time By Day";
    private string mSource = "/Customer Service/On Time By Day";
    private string mDSName = "OnTimeByDayDS";
    private string mUSPName = "uspRptOnTimeReportByDay",mTBLName = "NewTable";
