...
public partial class OnTimeByWindow :System.Web.UI.Page {
    //Members
    private string mTitle = "On Time By Window";
    private string mSource = "/Customer Service/On Time By Window";
    private string mDSName = "OnTimeReportByWindowDS";
    private string mUSPName = "uspRptOnTimeReportByWindow",mTBLName = "NewTable";
