...
public partial class OnTimeDeliveryDetailByStore :System.Web.UI.Page {
    //Members
    private string mTitle = "On Time Delivery Detail By Store";
    private string mSource = "/Executive/On Time Delivery Detail By Store";
    private string mDSName = "OnTimeDeliveryDetailByStoreDS";
    private string mUSPName = "uspRptOnTimeDeliveryDetailByStore",mTBLName = "NewTable";
