...
public partial class OnTimeDeliverySummaryByClient :System.Web.UI.Page {
    //Members
    private string mTitle = "On Time Delivery Summary By Client";
    private string mSource = "/Executive/On Time Delivery Summary By Client";
    private string mDSName = "OnTimeDeliverySummaryByClientDS";
    private string mUSPName = "uspRptOnTimeDeliverySummaryByClient",mTBLName = "NewTable";
