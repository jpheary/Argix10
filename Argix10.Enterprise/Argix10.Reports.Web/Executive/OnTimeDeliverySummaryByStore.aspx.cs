...
public partial class OnTimeDeliverySummaryByStore :System.Web.UI.Page {
    //Members
    private string mTitle = "On Time Delivery Summary By Store";
    private string mSource = "/Executive/On Time Delivery Summary By Store";
    private string mDSName = "OnTimeDeliverySummaryByStoreDS";
    private string mUSPName = "uspRptOnTimeDeliverySummaryByStore",mTBLName = "NewTable";
