                ...
                <asp:TableRow ID="thrVendorLog" Height="16px">
                    ...
                    <asp:TableCell HorizontalAlign="Right" SkinID="GridTitle">
                        ...
                        <ContentTemplate>
                            ...
                            <asp:ImageButton ID="imgFindLogEntry" runat="server" Height="16px" ImageAlign="Middle" ImageUrl="~/App_Themes/Reports/Images/search.gif" ToolTip="Search for a vendor log entry..." OnClick="OnFindVendorLogEntry" />&nbsp;
                        </ContentTemplate>
                        </asp:UpdatePanel>
                   </asp:TableCell>
                </asp:TableRow>
