<%@ Control Language="C#" AutoEventWireup="true" ClassName="ClientMultiShipperGrids" CodeFile="ClientMultiShipperGrids.ascx.cs" Inherits="ClientMultiShipperGrids" EnableTheming="true" %>
        ...
        <asp:TableCell>
            <asp:Table ID="tblClients" runat="server" Width="100%" Height="100%" BorderStyle="None" BorderWidth="0px" CellPadding="0" CellSpacing="0">
                <asp:TableRow ID="thrClients" Width="100%" Height="16px">
                    <asp:TableCell SkinID="GridTitle">&nbsp;Clients</asp:TableCell>
                    <asp:TableCell HorizontalAlign="Right" SkinID="GridTitle">
                        ...
                        <ContentTemplate>
                            ...
                            <asp:ImageButton ID="imgFindClient" runat="server" Height="16px" ImageAlign="Middle" ImageUrl="~/App_Themes/Reports/Images/search.gif" ToolTip="Search for a client..." OnClick="OnFindClient" />&nbsp;
                        </ContentTemplate>
                        </asp:UpdatePanel>
                    </asp:TableCell>
                </asp:TableRow>
                ...
                <asp:TableRow ID="thrShippers" Width="100%" Height="16px">
                    ...
                    <asp:TableCell HorizontalAlign="Right" SkinID="GridTitle">
                        ...
                        <ContentTemplate>
                            ...
                            <asp:ImageButton ID="imgFindShipper" runat="server" Height="16px" ImageAlign="Middle" ImageUrl="~/App_Themes/Reports/Images/search.gif" ToolTip="Search for a shipper..." OnClick="OnFindShipper" />&nbsp;
                        </ContentTemplate>
                        </asp:UpdatePanel>
                    </asp:TableCell>
                </asp:TableRow>
                            ...
                            <asp:GridView ID="grdShippers" runat="server" Width="100%" AutoGenerateColumns="False" AllowSorting="True" DataSourceID="odsShippers" OnSelectedIndexChanged="OnShipperSelected">
                                <Columns>
                                    <asp:TemplateField HeaderText="" HeaderStyle-Width="24px" >
                                        <ItemTemplate><asp:CheckBox ID="chkSelect" runat="server" AutoPostBack="true" OnCheckedChanged="OnShipperSelected"/></ItemTemplate>
                                    </asp:TemplateField>
