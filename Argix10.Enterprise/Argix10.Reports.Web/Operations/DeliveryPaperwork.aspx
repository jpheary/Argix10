    ...
    <table width="100%" border="0px" cellpadding="0px" cellspacing="3px">
        ...
        <tr>
            ...
            <td>&nbsp;
                ...
                <asp:ImageButton ID="imgFind" runat="server" Width="20px" ImageAlign="Middle" ImageUrl="~/App_Themes/Reports/Images/search.gif" ToolTip="Search for a TL..." OnClick="OnFind" />&nbsp;
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr style="font-size:1px"><td colspan="3">&nbsp;</td></tr>
