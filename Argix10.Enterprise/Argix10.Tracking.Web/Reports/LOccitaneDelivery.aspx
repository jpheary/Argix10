<%@ Page Language="C#" MasterPageFile="~/MasterPages/Reports.master" AutoEventWireup="true" CodeFile="LOccitaneDelivery.aspx.cs" Inherits="_LOccitaneDelivery" %>
    ...
    <div class="reports">
        <div>
            <fieldset>
                ...
                <label for="">Scope</label><asp:DropDownList ID="cboFilter" runat="server" Width="200px"><asp:ListItem Selected="True" Value="0">All</asp:ListItem><asp:ListItem Value="1">OS&amp;D Only</asp:ListItem></asp:DropDownList><br />
            </fieldset>
        </div>
    </div>
</asp:Content>
