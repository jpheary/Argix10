...
public partial class DeliveryWindowDetailByStore :System.Web.UI.Page {
    ...
    private const string REPORT_DESC = "The Delivery Window Detail By Store report provides store level carton data detailing deliveries against store windows.";
    private const string REPORT_SRC = "/Tracking/Delivery Window Detail By Store";
