<%@ Page Language="C#" MasterPageFile="~/MasterPages/Reports.master" AutoEventWireup="true" CodeFile="ScanningDetailByStore.aspx.cs" Inherits="ScanningDetailByStore" %>
    ...
    <div class="reports">
        <div>
            <fieldset>
                ...
                <br />
                <labelfor="chkExceptionsOnly">&nbsp;</label><asp:CheckBox ID="chkExceptionsOnly" runat="server" Text="Display exceptions only" OnCheckedChanged="OnExceptionsOnlyChecked" /><br />
            </fieldset>
        </div>
    </div>
