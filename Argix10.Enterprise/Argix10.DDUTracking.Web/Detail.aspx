...
<p></p>
  ...
  <div id="buttonContainerLeft" >
   ...
   <div id="labelContainer" >
       <asp:Label ID="lblDetailFootnote" runat="server" SkinID="lblText" Text="Tracking data provided by Argix Logistics as of  " Width="396px"></asp:Label> <!-- date/time appended in CS...   -->
    </div>
