...
public class Tracker: System.Web.Services.WebService {
    ...
    public TrackingDataset TrackCarton(string cartonNumber) {
        ...
        try {            
            ...
            if(this.Credentials != null && (Credentials.UserName == "dduuser" && Credentials.Password == "bn2011")) {
                ...
                if(number.Length == CARTON_LENGTH) {
                    ...
                    TrackingDataset ds = new EnterpriseGateway().TrackCartons(numbers,null,null);
    ...
    private void addErrorMessage(TrackingDataset ds,string cartonNumber, string message) {
        //
        ds.Clear();
        TrackingDataset.TrackingSummaryTableRow row = ds.TrackingSummaryTable.NewTrackingSummaryTableRow();
