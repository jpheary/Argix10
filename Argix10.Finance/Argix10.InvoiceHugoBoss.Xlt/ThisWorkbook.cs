...
namespace Argix.Finance {
    ...
    public partial class ThisWorkbook {
        //Members
        private const string USP_INVOICE = "uspInvTsortHugoBossInvoiceByReleaseDateGet",TBL_INVOICE = "ClientInvoiceTable";
        ...
        private void ThisWorkbook_Startup(object sender,System.EventArgs e) {
            ...
            try {
                ...
                string clid="",invoice="";  
#if DEBUG
                clid = "092"; invoice = "330658700";    //Hugo Boss: 092, 330528200
#endif
                if (cmd != null) {
