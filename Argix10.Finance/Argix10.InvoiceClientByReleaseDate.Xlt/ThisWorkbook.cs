    ...
    public partial class ThisWorkbook {
        ...
        private void ThisWorkbook_Startup(object sender,System.EventArgs e) {
            ...
            try {
                ...
                string clid="",invoice="";  
#if DEBUG
                clid = "048"; invoice = "330544800";    //Amscan: 048, 330544800
#endif
                if (cmd != null) {
        ...
        private void createDetailBody(InvoiceDataset.ClientInvoiceTableDataTable invoiceTable) {
            ...
            Excel.Range row0 = ws.Range[ws.Cells[ROW0_DETAIL + 1,1],ws.Cells[ROW0_DETAIL + 1,16]].EntireRow;
            ...
            ws.Range[ws.Cells[ROW0_DETAIL,1],ws.Cells[ROW0_DETAIL + rowCount - 1,16]].Value2 = values;
