...
namespace Argix.Finance {
    ...
    public partial class ThisWorkbook {
        //Members
        private const string USP_INVOICE = "uspInvGNCInvoiceByReleaseDateGet",TBL_INVOICE = "ClientInvoiceTable";
        ...
        private void ThisWorkbook_Startup(object sender,System.EventArgs e) {
            ...
            try {
                ...
                string clid = "",invoice = "";
#if DEBUG
                clid = "048"; invoice = "331238700";    //Amscan: 048, 331238700
#endif
                if (cmd != null) {
        ...
        private void createDetailHeader(InvoiceDataset.ClientInvoiceTableRow invoice) {
            ...
            detail.SCAC.Value = invoice.SCAC;
        }
        private void createDetailBody(InvoiceDataset.ClientInvoiceTableDataTable invoiceTable) {
            ...
            Excel.Range row0 = ws.Range[ws.Cells[ROW0_DETAIL + 1,1],ws.Cells[ROW0_DETAIL + 1,COLS]].EntireRow;
            ...
            object[,] values = new object[rowCount,COLS];
            for (int i = 0;i < rowCount;i++) {
                ...
                values[i,16] = invoiceTable[i].ManifestList;
            }
            ws.Range[ws.Cells[ROW0_DETAIL,1],ws.Cells[ROW0_DETAIL + rowCount - 1,COLS]].Value2 = values;
        ...
        private void createDetailTotals(InvoiceDataset.ClientInvoiceTableDataTable invoiceTable) {
            ...
            totals[0,14] = fs;
            totals[0,15] = dt;
            ws.Range[ws.Cells[ROW0_DETAIL + rowCount + 1,1],ws.Cells[ROW0_DETAIL + rowCount + 1,16]].Value2 = totals;
