...
namespace Argix.Finance {
    ...
    public partial class ThisWorkbook {
        ...
        #endregion
        private void createInvoiceHeader(string invoiceNumber, InvoiceDataset.InvoiceTotalTableRow total) {
        ...
        private int createInvoiceBodyShipments(InvoiceDataset.InvoiceShipmentTableRow shipment,int row0) {
            //Get worksheet
            int _rows = 0;
            Invoice invoice = global::Argix.Finance.Globals.Invoice;
            ...
            //Column headers
            _rows += 5;
            Excel.Range r = invoice.Range[invoice.Cells[row0 + 1,1],invoice.Cells[row0 + 1,12]];
            r.Borders[Microsoft.Office.Interop.Excel.XlBordersIndex.xlEdgeTop].Color = Color.Black.ToArgb();
            invoice.Range[invoice.Cells[row0 + 1,2],invoice.Cells[row0 + 1,12]].Value2 = new object[1,11] { { "Inland Charges","","","","","","","","","","" } };
            invoice.Range[invoice.Cells[row0 + 1,2],invoice.Cells[row0 + 1,2]].Font.Bold = true;
            invoice.Range[invoice.Cells[row0 + 2,2],invoice.Cells[row0 + 2,12]].Value2 = new object[1,11] { { "","","","","","","","","","","" } };
            invoice.Range[invoice.Cells[row0 + 3,2],invoice.Cells[row0 + 3,12]].Value2 = new object[1,11] { { "","","Trucking","Fuel","Devanning","","Airline","","","","" } };
            invoice.Range[invoice.Cells[row0 + 4,2],invoice.Cells[row0 + 4,12]].Value2 = new object[1,11] { { "","Custom DOC","Rate","Surcharge","Unite","Insurance","Import Fee","House B/L","Miscellaneous","Total Inland","" } };
            invoice.Range[invoice.Cells[row0 + 5,2],invoice.Cells[row0 + 5,12]].Value2 = new object[1,11] { { "Shipment#","Charges","Charges","Charges","Charges","Charges","Charges","Charges","Charges","Charges","" } };
            r = invoice.Range[invoice.Cells[row0 + 5,2],invoice.Cells[row0 + 5,11]];
            ...
            invoice.Range[invoice.Cells[row0 + 6,2],invoice.Cells[row0 + 6,11]].Value2 = _shipment;
            invoice.Range[invoice.Cells[row0 + 6,2],invoice.Cells[row0 + 6,2]].NumberFormat = "@";
            invoice.Range[invoice.Cells[row0 + 6,3],invoice.Cells[row0 + 6,3]].NumberFormat = "$#,##0.00_);($#,##0.00)";
            invoice.Range[invoice.Cells[row0 + 6,4],invoice.Cells[row0 + 6,4]].NumberFormat = "$#,##0.00_);($#,##0.00)";
            invoice.Range[invoice.Cells[row0 + 6,5],invoice.Cells[row0 + 6,5]].NumberFormat = "$#,##0.00_);($#,##0.00)";
            invoice.Range[invoice.Cells[row0 + 6,6],invoice.Cells[row0 + 6,6]].NumberFormat = "$#,##0.00_);($#,##0.00)";
            invoice.Range[invoice.Cells[row0 + 6,7],invoice.Cells[row0 + 6,7]].NumberFormat = "$#,##0.00_);($#,##0.00)";
            invoice.Range[invoice.Cells[row0 + 6,8],invoice.Cells[row0 + 6,8]].NumberFormat = "$#,##0.00_);($#,##0.00)";
            invoice.Range[invoice.Cells[row0 + 6,9],invoice.Cells[row0 + 6,9]].NumberFormat = "$#,##0.00_);($#,##0.00)";
            invoice.Range[invoice.Cells[row0 + 6,10],invoice.Cells[row0 + 6,10]].NumberFormat = "$#,##0.00_);($#,##0.00)";
            invoice.Range[invoice.Cells[row0 + 6,11],invoice.Cells[row0 + 6,11]].NumberFormat = "$#,##0.00_);($#,##0.00)";
            return _rows;
        }
        private int createInvoiceBodyDetails(InvoiceDataset ds, int row0) {
            ...
            invoice.Range[invoice.Cells[row0 + 2,2],invoice.Cells[row0 + 2,12]].Value2 = new object[1,11] { { "Distribution Charges","","","","","","","","","","" } };
            ...
            invoice.Range[invoice.Cells[row0 + 4,2],invoice.Cells[row0 + 4,12]].Value2 = new object[1,11] { { "","Delivery","","","","","","","Fuel","Fuel","Total Distrib." } };
            invoice.Range[invoice.Cells[row0 + 5,2],invoice.Cells[row0 + 5,12]].Value2 = new object[1,11] { { "Zone","Code","Store","Cartons","Weight(kg)","Weight(lbs)","Rate","Amount","Surcharge %","Surcharge","Charges" } };
            ...
            invoice.Range[invoice.Cells[row0 + 6 + rows,2],invoice.Cells[row0 + 6 + rows,12]].Value2 = new object[1,11] { { "","","","","","","","","","Total:",totalDistributionCharges } };
        ...
        private int createInvoiceTotals(InvoiceDataset.InvoiceTotalTableRow total,int row0) {
            //Get worksheet
            int _rows = 0;
            Invoice invoice = global::Argix.Finance.Globals.Invoice;
            ...
            Excel.Range r = invoice.Range[invoice.Cells[row0 + 1,1],invoice.Cells[row0 + 1,12]];
            r.Borders[Microsoft.Office.Interop.Excel.XlBordersIndex.xlEdgeTop].Color = Color.Black.ToArgb();
            invoice.Range[invoice.Cells[row0 + 1,2],invoice.Cells[row0 + 1,12]].Value2 = new object[1,11] { { "Invoice Total","","","","","","","","","","" } };
            invoice.Range[invoice.Cells[row0 + 1,2],invoice.Cells[row0 + 1,2]].Font.Bold = true;
            invoice.Range[invoice.Cells[row0 + 2,2],invoice.Cells[row0 + 2,12]].Value2 = new object[1,11] { { "","","","","","","","","","","" } };
            invoice.Range[invoice.Cells[row0 + 3,2],invoice.Cells[row0 + 3,12]].Value2 = new object[1,11] { { "","","","Inland","Distribution","Total","","","","","" } };
            r = invoice.Range[invoice.Cells[row0 + 4,2],invoice.Cells[row0 + 4,12]];
            ...
            invoice.Range[invoice.Cells[row0 + 5,2],invoice.Cells[row0 + 5,7]].Value2 = totals;
            invoice.Range[invoice.Cells[row0 + 5,2],invoice.Cells[row0 + 5,2]].NumberFormat = "#,##0";
            invoice.Range[invoice.Cells[row0 + 5,3],invoice.Cells[row0 + 5,3]].NumberFormat = "#,##0.00";
            invoice.Range[invoice.Cells[row0 + 5,4],invoice.Cells[row0 + 5,4]].NumberFormat = "#,##0.00";
            invoice.Range[invoice.Cells[row0 + 5,5],invoice.Cells[row0 + 5,5]].NumberFormat = "$#,##0.00_);($#,##0.00)";
            invoice.Range[invoice.Cells[row0 + 5,6],invoice.Cells[row0 + 5,6]].NumberFormat = "$#,##0.00_);($#,##0.00)";
            invoice.Range[invoice.Cells[row0 + 5,7],invoice.Cells[row0 + 5,7]].NumberFormat = "$#,##0.00_);($#,##0.00)";
            return _rows;
        }
