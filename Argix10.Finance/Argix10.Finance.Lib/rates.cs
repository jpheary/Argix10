...
namespace Argix.Finance {
    ...
    public class DriverRates {
        ...
        #endregion
        private DriverCompDataset.RateMileageTableRow getMileRates(string agentNumber,int equipmentTypeID,decimal miles) {
            //Get a mileage rate
        ...
        private DriverCompDataset.RateUnitTableRow getUnitRates(string agentNumber,int equipmentTypeID) {
            //Get all unit rates
        ...
        private DriverCompDataset.RateMileageRouteTableRow getMileRouteRates(string agentNumber,string route,decimal miles) {
            //Get a mileage rate
        ...
        private DriverCompDataset.RateUnitRouteTableRow getUnitRouteRates(string agentNumber,string route) {
            //Get all unit rates
