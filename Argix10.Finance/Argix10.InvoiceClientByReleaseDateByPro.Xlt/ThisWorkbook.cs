    ...
    public partial class ThisWorkbook {
        ...
        private void ThisWorkbook_Startup(object sender,System.EventArgs e) {
            ...
            try {
                ...
                string clid="",invoice="";  
#if DEBUG
                clid = "061"; invoice = "330543300";    //Yankee: 061, 330543300
#endif
                if (cmd != null) {
        ...
        private void createDetailBody(InvoiceDataset.ClientInvoiceTableDataTable invoiceTable) {
            ...
            Excel.Range row0 = ws.Range[ws.Cells[ROW0_DETAIL + 1,1],ws.Cells[ROW0_DETAIL + 1,14]].EntireRow;
            ...
            ws.Range[ws.Cells[ROW0_DETAIL,1],ws.Cells[ROW0_DETAIL + rowCount - 1,14]].Value2 = values;
