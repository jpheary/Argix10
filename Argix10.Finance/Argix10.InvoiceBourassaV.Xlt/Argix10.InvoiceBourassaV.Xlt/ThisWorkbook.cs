...
namespace Argix.Finance {
    ...
    public partial class ThisWorkbook {
        //Members
        private const string USP_INVOICE = "uspInvTsortVendorInvoiceSortedFreightGet",TBL_INVOICE = "VendorInvoiceTable";
        ...
        private void showDetail(InvoiceDataset.VendorInvoiceTableDataTable invoiceTable) {
            //Get worksheet
            ...
            for (int i = 0;i < rowCount;i++) {
                ...
                values[i,3] = "'" + invoiceTable[i].StoreBLNumber.Trim();
                ...
                values[i,12] = invoiceTable[i].IsConsolidationChargeNull() ? 0.0m : invoiceTable[i].ConsolidationCharge;
