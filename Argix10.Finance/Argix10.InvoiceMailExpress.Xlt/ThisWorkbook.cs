...
namespace Argix.Finance
{
    public partial class ThisWorkbook {
        ...
        private Excel.Range getRange(Detail ws,int fromR,int fromC,int toR,int toC) {
            return ws.Range[ws.Cells[fromR,fromC],ws.Cells[toR,toC]];
        }
        private Excel.Range getRange(Detail ws,int row,int column) {
