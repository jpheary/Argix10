...
namespace Argix.Finance {
    ...
    public partial class ThisWorkbook {
...
#if DEBUG
                clid = "003"; invoice = "332111700";    //Amscan: 048, 330544800
#endif
                if (cmd != null) {
        ...
        private void createDetailBody(InvoiceDataset.VendorInvoiceTableDataTable invoiceTable) {
            ...
            Excel.Range row0 = ws.Range[ws.Cells[ROW0_DETAIL + 1,1],ws.Cells[ROW0_DETAIL + 1,20]].EntireRow;
            ...
            ws.Range[ws.Cells[ROW0_DETAIL,1],ws.Cells[ROW0_DETAIL + rowCount - 1,20]].Value2 = values;
