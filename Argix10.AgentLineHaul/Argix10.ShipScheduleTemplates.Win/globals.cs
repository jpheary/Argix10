...
namespace Argix {
    ...
    public class App :AppBase {
        ...
        public static void Trace(string message, LogLevel level) {
            ...
            if (level >= _Config.TraceLevel) {
                ...
                m.LogLevel = level;
                m.Message = message;
                ShipScheduleTemplatesGateway.WriteLogEntry(m);
            }
        }
    ...
    public class ShipScheduleConfiguration {
        ...
        public ShipScheduleConfiguration() {
            //Constructor
            this.mConfig = ShipScheduleTemplatesGateway.GetUserConfiguration(App.Product, new string[] { Environment.UserName, Environment.MachineName });
        }
