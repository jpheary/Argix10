...
namespace Argix {
    ...
    public class App :AppBase {
		//Members
        private static ISDExportConfiguration _Config = null;
				
		//Interface
		static App() { 
			//Class constructor: get application configuration
			try {
                _Config = new ISDExportConfiguration();
            }
			catch(Exception ex) { ReportError(ex); Application.Exit(); }
		}
        internal static ISDExportConfiguration Config { get { return _Config; } }
    ...
    public class ISDExportConfiguration {
        //Memnbers
        ...
        public int DateDaysBack {
            get { return global::Argix.Properties.Settings.Default.DateDaysBack; }
            set { global::Argix.Properties.Settings.Default.DateDaysBack = value; }
        }
    }		
}