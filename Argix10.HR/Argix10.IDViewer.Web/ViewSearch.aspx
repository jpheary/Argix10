            ...
            <table width="100%" border="0px" cellpadding="2px" cellspacing="0px">
                <tr>
                    ...
                    <td>
                        ...
                        <asp:ObjectDataSource ID="odsTypes" runat="server" SelectMethod="GetIDTypes" TypeName="Argix.HR.BadgeGateway" CacheExpirationPolicy="Absolute" CacheDuration="900" EnableCaching="true" />
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="4" valign="top" align="center">
                        <asp:Panel id="pnlEmployees" runat="server" Width="98%" Height="280px" BorderStyle="None" BorderWidth="1px" ScrollBars="Vertical">
                            ...
                            <asp:ObjectDataSource ID="odsEmployees" runat="server" TypeName="Argix.HR.BadgeGateway" SelectMethod="SearchEmployees">
                                <SelectParameters>
                ...
                <tr>
                    <td colspan="3" valign="top" align="center" style="background-color:White; border:solid 1px black; border-top:none">
                        <asp:Panel id="pnlEmployee" runat="server" Width="98%" Height="250px" BorderStyle="None" BorderWidth="1px" ScrollBars="Vertical">
                            ...
                            <asp:ObjectDataSource ID="odsEmployee" runat="server" TypeName="Argix.HR.BadgeGateway" SelectMethod="GetEmployee" EnableCaching="true" CacheExpirationPolicy="Sliding" CacheDuration="900" >
                                <SelectParameters>
                                    <asp:Parameter Name="idType" DefaultValue="" ConvertEmptyStringToNull="true" Type="String" />
