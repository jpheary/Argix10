<%@ Page Language="C#" masterpagefile="~/Default.master" AutoEventWireup="true" CodeFile="ChangeVehicle.aspx.cs" Inherits="_ChangeVehicle" %>
...
<div class="permit">
    <div class="subtitle">Change Vehicle for Permit#&nbsp;<asp:Label ID="lblPermitNumber" runat="server" Width="100px" Text="" /></div>
