...
namespace Argix {
	...
	public class ReminderService {
		//Members
        private RemindersDataset mReminders=null, mOpenReminders=null;
        ...
        public ReminderService() { 
            ...
            this.mOpenReminders = new RemindersDataset();
        ...
        public void Start() {
            this.Reminders = global::Argix.Properties.Settings.Default.Reminders;
            this.mTimer.Start();
        }
        public void Stop() {
            this.mTimer.Stop(); 
            global::Argix.Properties.Settings.Default.Reminders = this.Reminders;
        }
