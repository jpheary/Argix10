            ...
            <div class="address">
                ...
                <div>
                    ...
                    <fieldset>
                        ...
                        <label for="txtWindowOpen">Open</label><asp:TextBox ID="txtWindowOpen" runat="server" Width="100px" />
                        &nbsp;&nbsp;-&nbsp;&nbsp;<asp:TextBox ID="txtWindowClose" runat="server" Width="100px" /><br />
                    </fieldset>
                    </ContentTemplate>
                    </asp:UpdatePanel>
                    <br />
                    <div>
                        ...
                        <asp:Button ID="btnSubmit" runat="server" Text="Submit" ValidationGroup="vgConsignee" CommandName="Submit" OnCommand="OnCommand" />
                    ...
                    <asp:RequiredFieldValidator ID="rfvStreet" runat="server" ControlToValidate="txtAddressLine1" ErrorMessage="Street is required." ValidationGroup="vgConsignee" />
                    ...
                    <asp:RequiredFieldValidator ID="rfvZip" runat="server" ControlToValidate="txtZip5" ErrorMessage="Zip is required." ValidationGroup="vgConsignee" />
                    ...
                    <asp:RequiredFieldValidator ID="rfvContactPhone" runat="server" ControlToValidate="txtContactPhone" ErrorMessage="Contact phone number is required." ValidationGroup="vgConsignee" />
                </div>
            </div>
