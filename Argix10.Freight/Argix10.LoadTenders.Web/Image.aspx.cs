...
public partial class _Image:System.Web.UI.Page {
    ...
    private const char RE_START128_A = (char)135;		//135 8225;
    private const char RE_START128_B = (char)202;
    private const char RE_START128_C = (char)8240;
    private const char RE_STOP128 = (char)138;			//138 352;
    ...
    protected override void Render(HtmlTextWriter output) {
        ...
        try {
            ...
            bitmap = new Bitmap(900,125);
            graphics = Graphics.FromImage(bitmap);
            graphics.TextRenderingHint = System.Drawing.Text.TextRenderingHint.SingleBitPerPixel;
            graphics.FillRectangle(Brushes.White,new RectangleF(0,0,800,100));

            string barcode = Encode128AB(this.mBarcode,"Code128A",Barcode128.A);
            System.Diagnostics.Debug.WriteLine(barcode);
            Font font = new Font("Code128A",72);    //Code128A, BCW_Code128A_1, IDAutomationSC128L DEMO
