...
/****** Object:  StoredProcedure [dbo].[uspLTLConsigneeCreate]    Script Date: 03/03/2014 11:08:48 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[uspLTLConsigneeCreate] 
    @ID	int OUTPUT
   ,@ClientID int
   ,@Name varchar(40)
...
AS
BEGIN
	INSERT INTO [Tsort].[dbo].[ltlConsignee] (
			ClientID, 
