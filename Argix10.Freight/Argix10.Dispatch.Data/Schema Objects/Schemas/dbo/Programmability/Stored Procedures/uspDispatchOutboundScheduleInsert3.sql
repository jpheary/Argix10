...
/****** Object:  StoredProcedure [dbo].[uspDispatchOutboundScheduleInsert3]    Script Date: 03/03/2014 11:32:33 ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[uspDispatchOutboundScheduleInsert3] 
	@Created datetime,
...
AS
BEGIN
	INSERT INTO Tsort.dbo.dspOutboundSchedule (
