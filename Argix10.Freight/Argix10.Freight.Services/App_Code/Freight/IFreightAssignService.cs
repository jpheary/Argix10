...
namespace Argix.Freight {
    ...
    public interface IFreightAssignService {
        ...
        DataSet GetInboundFreight(int terminalID,DateTime fromDate);

        [OperationContract]
        [FaultContractAttribute(typeof(TsortFault),Action = "http://Argix.Freight.TsortFault")]
        InboundShipment GetInboundShipment(int terminalID,string freightID);

        [OperationContract]
        [FaultContractAttribute(typeof(TsortFault),Action = "http://Argix.Freight.TsortFault")]
        bool StartSort(InboundShipment shipment);

        [OperationContract]
        [FaultContractAttribute(typeof(TsortFault),Action = "http://Argix.Freight.TsortFault")]
        bool StopSort(InboundShipment shipment);

        [OperationContract]
        [FaultContractAttribute(typeof(TsortFault),Action = "http://Argix.Freight.TsortFault")]
        DataSet GetStationAssignments(int terminalID);
        ...
        [OperationContract]
        [FaultContractAttribute(typeof(TsortFault),Action = "http://Argix.Freight.TsortFault")]
        bool DeleteStationAssignment(StationAssignment assignment);

        [OperationContract]
        [FaultContractAttribute(typeof(TsortFault),Action = "http://Argix.Freight.TsortFault")]
        DataSet GetFreightSortTypes(int terminalID,string freightID);

        [OperationContract]
        [FaultContractAttribute(typeof(TsortFault),Action = "http://Argix.Freight.TsortFault")]
        DataSet GetAssignableSortStations(int terminalID,string freightID,int sortTypeID);
    }
    ...
    public class InboundShipment {
        ...
        public InboundShipment(FreightDataset.InboundFreightTableRow shipment) {
            //Constructor
            try {
                if (shipment != null) {
    ...
    public class Workstation {
        ...
        public Workstation(FreightDataset.WorkstationTableRow workstation) {
            //Constructor
            try {
