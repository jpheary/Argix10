...
namespace Argix.Freight {
    ...
    [ServiceContract(Namespace = "http://Argix.Freight")]
    public interface ITLViewerService2 {
        //General Shipping Interface
        [OperationContract]
        [FaultContractAttribute(typeof(TLViewerFault),Action = "http://Argix.Freight.TLViewerFault")]
        DataSet GetTerminals2();
        [OperationContract]
        [FaultContractAttribute(typeof(TLViewerFault),Action = "http://Argix.Freight.TLViewerFault")]
        DataSet GetTLView2(int terminalID);
        [OperationContract]
        [FaultContractAttribute(typeof(TLViewerFault),Action = "http://Argix.Freight.TLViewerFault")]
        DataSet GetTLDetail2(int terminalID,string tlNumber);
        [OperationContract]
        [FaultContractAttribute(typeof(TLViewerFault),Action = "http://Argix.Freight.TLViewerFault")]
        DataSet GetAgentSummary2(int terminalID);
    }
    ...
    public class TL {
        ...
        //Interface
        public TL() : this(null) { }
        public TL(FreightDataset.TLTableRow tl) {
            //Constructor
            if(tl != null) {
    ...
    [DataContract]
    public class TLViewerFault {
        private string mMessage = "";
        public TLViewerFault(string message) { this.mMessage = message; }
        [DataMember]
