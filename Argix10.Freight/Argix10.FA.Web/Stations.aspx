...
<div style="border:1px solid #000000; border-top-style:none; padding:10px 10px 10px 10px; margin-top:25px">
    ...
    <div class="pageBody">
        <asp:GridView ID="grdStations" runat="server" Width="100%" Height="100%" DataSourceID="odsStations" DataKeyNames="WorkStationID,FreightID,SortTypeID" AutoGenerateColumns="false" OnSelectedIndexChanged="OnAssignmentSelected" >
            <Columns>
                ...
                <asp:BoundField DataField="WorkStationID" HeaderText="ID" ItemStyle-Width="50px" ItemStyle-Wrap="False" Visible="False" />
                <asp:BoundField DataField="StationNumber" HeaderText="Station#" ItemStyle-Width="50px" ItemStyle-Wrap="False" Visible="True" />
                <asp:BoundField DataField="FreightID" HeaderText="FreightID" ItemStyle-Width="50px" ItemStyle-Wrap="False" Visible="False" />
                <asp:BoundField DataField="FreightType" HeaderText="Type" ItemStyle-Width="50px" ItemStyle-Wrap="False" Visible="True" />
                <asp:BoundField DataField="SortTypeID" HeaderText="SortTypeID" ItemStyle-Width="50px" ItemStyle-Wrap="False" Visible="False" />
                <asp:BoundField DataField="SortType" HeaderText="Sort Type" ItemStyle-Width="50px" ItemStyle-Wrap="False" Visible="True" />
                ...
                <asp:BoundField DataField="Client" HeaderText="Client" ItemStyle-Width="50px" ItemStyle-Wrap="False" Visible="True" />
                <asp:BoundField DataField="Shipper" HeaderText="Shipper" ItemStyle-Width="50px" ItemStyle-Wrap="False" Visible="True" />
                <asp:BoundField DataField="Pickup" HeaderText="Pickup" ItemStyle-Width="50px" ItemStyle-Wrap="False" Visible="True" />
                <asp:BoundField DataField="TerminalID" HeaderText="TerminalID" ItemStyle-Width="50px" ItemStyle-Wrap="False" Visible="False" />
                <asp:BoundField DataField="Result" HeaderText="Result" ItemStyle-Width="50px" ItemStyle-Wrap="False" Visible="True" />
            </Columns>
        </asp:GridView>
