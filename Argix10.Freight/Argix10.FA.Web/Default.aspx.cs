...
public partial class Default:System.Web.UI.Page {
    ...
    protected void OnShipmentSelected(object sender,EventArgs e) { OnValidateForm(null,EventArgs.Empty); }
    ...
    protected void OnValidateForm(object sender,EventArgs e) {
        ...
        try {
            this.btnAssign.Enabled = this.grdShipments.SelectedRow != null;
        }
        catch (Exception ex) { Master.ReportError(ex); }
    }
}
