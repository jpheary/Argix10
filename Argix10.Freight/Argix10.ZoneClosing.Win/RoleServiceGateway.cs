...
namespace Argix.Security {
    ...
    public class RoleServiceGateway {
        ...
        private const string ROLE_SUPERVISOR = "Shipping Supervisor";
        private const string ROLE_CLERK = "Shipping Clerk";
        ...
        public static string GetRoleForCurrentUser() {
            if (IsShippingSupervisor) return ROLE_SUPERVISOR;
            else if (IsShippingClerk) return ROLE_CLERK;
            else {
