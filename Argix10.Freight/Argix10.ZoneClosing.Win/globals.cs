...
namespace Argix {
    ...
    public class TsortConfiguration {
        ...
        [Category("Data"),Description("Read only rights.")]
        public int ClosedTLsDays { get { return int.Parse(this.mConfig["ClosedTLsDays"]); } set { this.mConfig["ClosedTLsDays"] = value.ToString(); } }
        [Category("Appearance"),Description("Read only rights.")]
        public bool ShowLaneChanges { get { return Convert.ToBoolean(this.mConfig["ShowLaneChanges"]); } set { this.mConfig["ShowLaneChanges"] = value.ToString(); } }
        [Category("Appearance"),Description("Read only rights.")]
        public bool ShowShipSchedule { get { return Convert.ToBoolean(this.mConfig["ShowShipSchedule"]); } set { this.mConfig["ShowShipSchedule"] = value.ToString(); } }
    }
