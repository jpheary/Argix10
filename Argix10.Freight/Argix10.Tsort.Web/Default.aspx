...
<div style="border:1px solid #000000; border-top-style:none; padding:10px 10px 10px 10px; margin-top:25px">
    ...
    <div class="pageBody">
        <asp:GridView ID="grdShipments" runat="server" Width="100%" Height="100%" DataSourceID="odsShipments" DataKeyNames="FreightID" AutoGenerateColumns="false" AllowSorting="true" >
            <Columns>
                ...
                <asp:BoundField DataField="FreightID" HeaderText="ID" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="FreightID" Visible="False" />
                <asp:BoundField DataField="FreightType" HeaderText="Type" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="FreightType" Visible="False" />
                <asp:BoundField DataField="CurrentLocation" HeaderText="Location" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="CurrentLocation" Visible="True" />
                ...
                <asp:BoundField DataField="ClientNumber" HeaderText="Client#" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="ClientNumber" Visible="True" />
                <asp:BoundField DataField="ClientName" HeaderText="Client" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="ClientName" Visible="True" />
                <asp:BoundField DataField="ShipperNumber" HeaderText="Shipper#" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="ShipperNumber" Visible="True" />
                <asp:BoundField DataField="ShipperName" HeaderText="Shipper" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="ShipperName" Visible="True" />
                ...
                <asp:BoundField DataField="Status" HeaderText="Status" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="Status" Visible="True" />
                <asp:BoundField DataField="Cartons" HeaderText="Cartons" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="Cartons" Visible="True" />
                <asp:BoundField DataField="Pallets" HeaderText="Pallets" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="Pallets" Visible="True" />
                <asp:BoundField DataField="CarrierNumber" HeaderText="Carrier#" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="CarrierNumber" Visible="False" />
                <asp:BoundField DataField="DriverNumber" HeaderText="Driver#" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="FloorStatus" Visible="False" />
                <asp:BoundField DataField="FloorStatus" HeaderText="Floor" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="" Visible="False" />
                <asp:BoundField DataField="SealNumber" HeaderText="Seal#" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="SealNumber" Visible="False" />
                <asp:BoundField DataField="UnloadedStatus" HeaderText="UnStatus" ItemStyle-Width="50px" ItemStyle-Wrap="False" Visible="False" />
                <asp:BoundField DataField="VendorKey" HeaderText="VendorKey" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="VendorKey" Visible="True" />
                ...
                <asp:BoundField DataField="IsSortable" HeaderText="Sort?" ItemStyle-Width="50px" ItemStyle-Wrap="False" SortExpression="IsSortable" Visible="True" />
            </Columns>
        </asp:GridView>
