...
namespace Argix.Freight {
    //
    public partial class dlgLabels:Form {
        //Members
        private string mShipmentNumber = "";

        //Interface
        public dlgLabels(string shipmentNumber) {
            //
            InitializeComponent();
        ...
        private void OnFormLoad(object sender,System.EventArgs e) {
            ...
            try {
                ...
                this.rsDialog.ServerReport.DisplayName = "Pallet Shipment Labels";
                this.rsDialog.ServerReport.ReportPath = "/Freight/Pallet Shipment Labels";
