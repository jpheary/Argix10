<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/Default.master" AutoEventWireup="true" CodeFile="InboundSchedule.aspx.cs" Inherits="InboundSchedule" %>
...
<asp:Content ID="cBody" ContentPlaceHolderID="cphBody" Runat="Server">
    ...
    <asp:UpdatePanel ID="upnlSchedule" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div id="grid">
                <asp:GridView ID="grdSchedule" runat="server" BackColor="Window" AutoGenerateColumns="False" DataSourceID="odsInbound" AllowSorting="true" >
                ...
                <asp:ObjectDataSource ID="odsInbound" runat="server" TypeName="Argix.Freight.FreightGateway" SelectMethod="ViewInboundSchedule" >
                    <SelectParameters>
