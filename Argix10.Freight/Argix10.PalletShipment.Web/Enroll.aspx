...
Please provide the following information so that we may acknowledge and process your request for enrollment.
...
<ContentTemplate>
    <table>
        ...
        <tr><td class="labelx">Confirm Password</td></tr>
...
<br />
<br />
<div><asp:Button ID="btnSubmit" runat="server" Text="Submit" ValidationGroup="vgEnroll" CssClass="submit" OnClick="OnSubmit" /></div>
<br />
...
<%--<asp:RequiredFieldValidator ID="rfvTaxIDNumber" runat="server" ControlToValidate="txtTaxIDNumber" ErrorMessage="Federal TaxID Number is required." ValidationGroup="vgEnroll" />
--%></asp:Content>
