...
<div style="float:left">
    <table>
        ...
        <tr><td>
            <asp:UpdatePanel runat="server" ID="upnlZip" UpdateMode="Always" RenderMode="Inline"><ContentTemplate><asp:TextBox ID="txtZip" runat="server" Width="75px" AutoPostBack="true" OnTextChanged="OnZipChanged" onchange="javascript: updateMap();" /></ContentTemplate></asp:UpdatePanel>
    ...
    <table>
        ...
        <tr><td><asp:UpdatePanel runat="server" ID="upnlAddress" UpdateMode="Always" RenderMode="Inline"><ContentTemplate>
                <asp:TextBox ID="txtStreet" runat="server" Width="275px" onchange="javascript: updateMap();" />
                &nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtCity" runat="server" Width="175px" onchange="javascript: updateMap();" />
                &nbsp;&nbsp;&nbsp;<asp:TextBox ID="txtState" runat="server" Width="50px" onchange="javascript: updateMap();" />
        ...
        <tr><td class="labelx">Hours of Operation (0 - 2359)</td></tr>
    ...
    <asp:RequiredFieldValidator ID="rfvStreet" runat="server" ControlToValidate="txtStreet" ErrorMessage="Street is required." ValidationGroup="vgShipper" />
    ...
    <asp:RequiredFieldValidator ID="rfvZip" runat="server" ControlToValidate="txtZip" ErrorMessage="Zip is required." ValidationGroup="vgShipper" />
    ...
    <asp:RequiredFieldValidator ID="rfvContactEmail" runat="server" ControlToValidate="txtContactEmail" ErrorMessage="Contact email is required." ValidationGroup="vgShipper" />
</div>
