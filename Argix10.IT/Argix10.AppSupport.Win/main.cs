	...
	public class frmMain : System.Windows.Forms.Form {
		...
		private void OnFormLoad(object sender, System.EventArgs e) {
			...
			try {
				...
				this.mnuViewToolbar.Checked = this.tlbMain.Visible = true;
				this.mnuViewStatusBar.Checked = this.stbMain.Visible = true;
				Application.DoEvents();
				#endregion
				#region Tooltips
		...
		private void OnFormResize(object sender, System.EventArgs e) {
			...
			try {
			if(this.WindowState == FormWindowState.Minimized) this.Visible = !this.mTrayIcon.ContextMenu.MenuItems[0].Checked;
			}
			catch(Exception ex) { App.ReportError(ex); }
		}
