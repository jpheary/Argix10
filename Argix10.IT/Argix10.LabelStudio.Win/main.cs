...
namespace Argix.Tools {
	...
	public class frmMain : System.Windows.Forms.Form {
		...
		private void InitializeComponent()
		{
            ...
            this.ctlPrinters = new Argix.Devices.Printers.LabelPrinters();
            ...
            // csNavOpen
            // 
            this.csNavOpen.Image = global::Argix.Properties.Resources.Open;
            ...
            // csNavProperties
            // 
            this.csNavProperties.Image = global::Argix.Properties.Resources.Properties;
            ...
            this.msFileOpenPort.Size = new System.Drawing.Size(152,22);
            ...
            this.msFileClosePort.Size = new System.Drawing.Size(152,22);
            ...
            // msEditUndo
            // 
            this.msEditUndo.Image = global::Argix.Properties.Resources.Edit_Undo;
            ...
            // msEditRedo
            // 
            this.msEditRedo.Image = global::Argix.Properties.Resources.Edit_Redo;
            ...
            this.msViewLabelMaker.Size = new System.Drawing.Size(152,22);
            ...
            this.msViewSerialPort.Size = new System.Drawing.Size(152,22);
            ...
            this.msViewRS232.Size = new System.Drawing.Size(152,22);
            ...
            this.msViewZebraPrinter.Size = new System.Drawing.Size(152,22);
            ...
            this.msViewStatusLog.Size = new System.Drawing.Size(152,22);
            ...
            this.msViewSep3.Size = new System.Drawing.Size(149,6);
            // 
            // msViewToolbar
            // 
            ...
            this.tsFind.Image = global::Argix.Properties.Resources.Find;
            ...
            // csNavRefresh
            // 
            this.csNavRefresh.Image = global::Argix.Properties.Resources.Refresh;
            ...
            this.tsPrintLabel.Image = global::Argix.Properties.Resources.Envelope;
            ...
            this.tsUndo.Image = global::Argix.Properties.Resources.Edit_Undo;
            ...
            this.tsRedo.Image = global::Argix.Properties.Resources.Edit_Redo;
			...
			try {
				if(this.ctlPrinters.Printer != null) {
					...
					if(this.ctlPrinters.Printer.On) {
                        ...
                        //if((e.EventType & System.IO.Ports.SerialPinChange.DsrChanged) > 0)
                        //    LogEvent(LOG_ID_RS232 + ": " + ((this.ctlPrinters.Printer.DsrHolding) ? "DSR High" : "DSR Low") + " \n");
                        //if((e.EventType & System.IO.Ports.SerialPinChange.CDChanged) > 0)
                        //    LogEvent(LOG_ID_RS232 + ": " + ((this.ctlPrinters.Printer.CDHolding) ? "CD High" : "CD Low") + " \n");
                        //if((e.EventType & System.IO.Ports.SerialPinChange.CtsChanged) > 0)
                        //    LogEvent(LOG_ID_RS232 + ": " + ((this.ctlPrinters.Printer.CtsHolding) ? "CTS High" : "CTS Low") + " \n");
                        //if((e.EventType & System.IO.Ports.SerialPinChange.Ring) > 0)
		...
		private void refreshPrinterStatus() {
			...
			try {
				...
				//if(this.ctlPrinters.Printer != null && this.ctlPrinters.Printer.On) this.ctlPrinters.Printer.GetHostInfo();
			}
			catch(Exception ex) { App.ReportError(ex); }
			finally { setUserServices(); }
		}
			...
			try  {
				...
				switch(item.Name)  {
                    ...
                    case "tsOpen": 
						...
						try {
							Form frm=null;
							LabelTemplateNode oTemplateNode = (LabelTemplateNode)this.trvStores.SelectedNode;
							for(int i=0; i< this.MdiChildren.Length; i++) {
								if(this.MdiChildren[i].Text.IndexOf(oTemplateNode.FullPath) > 0) {
									frm = this.MdiChildren[i];
									break;
								}
							}
							if(frm == null) {
								this.mMessageMgr.AddMessage("Loading " + oTemplateNode.Text + " configuration...");
								winLabel dlgEdit = new winLabel(oTemplateNode, this.mLabelMaker);
								dlgEdit.ServiceStatesChanged += new EventHandler(OnServiceStatesChanged);
								if(this.MdiChildren.Length > 0) 
									dlgEdit.WindowState = this.ActiveMdiChild.WindowState;
								else
									dlgEdit.WindowState = FormWindowState.Maximized;
								dlgEdit.MdiParent = this;
								dlgEdit.Show();
							}
							else
								frm.Activate();
		...
		private void setUserServices() {
			...
			try {
                ...
                this.msFilePrintLabel.Enabled = this.tsPrintLabel.Enabled = this.ctlPrinters.Printer != null && this.ctlPrinters.Printer.On;
