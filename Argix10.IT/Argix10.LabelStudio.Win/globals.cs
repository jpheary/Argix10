...
namespace Argix {
    ...
    public class App: AppBase {
        ...
        public static string EventLogName { get { return "Argix10"; } }
            ...
            public override void LoadChildNodes() {
                ...
                try {
                    ...
                    for(int i=0;i<this.mLabelStore.Labels.LabelDetailTable.Rows.Count;i++) {
                        LabelTemplate template = this.mLabelStore.NewLabelTemplate((LabelDataset.LabelDetailTableRow)this.mLabelStore.Labels.LabelDetailTable.Rows[i]);
